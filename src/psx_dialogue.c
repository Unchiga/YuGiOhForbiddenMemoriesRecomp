...
static void write_header(FILE *f, const char *what)
{
    ...
    fprintf(f,
        ...
        ";    codes (colors, pauses, portraits, music, jumps between texts). {FA} is a page break (wait for X).\n"
        ...
        ";    player's name; {F8 0A 01} sets the color (0 white 1 yellow 2 blue 3 green 4 grey 5 orange 6 red).\n"
